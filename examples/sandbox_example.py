...
# Fragment/Representation an arbitrary subset of a component, has its own set of resolutions
...
# so what if we create a little object with a clear relationship to the hierarchy, and create it only ONCE (also reversible).
...
# make some "selections" (these should be like python sets) (can also just use python indexing)
